...
import com.teachMeSkills.lesson27.twitterServlet.service.CommentService;
...
public class CommentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        com.teachMeSkills.lesson27.twitterServlet.entity.Comment comment = new Comment(idComment, text, user.getLogin());
